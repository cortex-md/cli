...
var securityPatterns = []struct {
	...
	{regexp.MustCompile(`@tauri-apps/api`), "critical", "Direct Tauri API usage detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`@tauri-apps/plugin`), "critical", "Direct Tauri plugin usage detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`tauri\.invoke`), "critical", "Direct Tauri invoke detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`__TAURI__`), "critical", "Direct Tauri global detected - use @cortex.md/api instead"},

	{regexp.MustCompile(`from\s+['"]react-native['""]`), "critical", "Direct React Native import detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`from\s+['"]expo-`), "critical", "Direct Expo import detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`import\s*\{[^}]*\}\s*from\s+['"]react-native`), "critical", "Direct React Native import detected - use @cortex.md/api instead"},

	{regexp.MustCompile(`from\s+['"]fs['""]`), "critical", "Direct Node.js fs import detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`from\s+['"]node:fs['""]`), "critical", "Direct Node.js fs import detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`require\s*\(\s*['"]fs['"]\s*\)`), "critical", "Direct Node.js fs require detected - use @cortex.md/api instead"},
	{regexp.MustCompile(`from\s+['"]path['""]`), "warning", "Direct Node.js path import detected - use @cortex.md/api utilities"},
	{regexp.MustCompile(`from\s+['"]node:path['""]`), "warning", "Direct Node.js path import detected - use @cortex.md/api utilities"},
